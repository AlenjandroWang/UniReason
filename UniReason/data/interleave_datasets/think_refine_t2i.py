...
class ThinkRefineT2IIterableDataset(InterleavedBaseIterableDataset, DistributedIterableDataset):
    def __init__(
        self, 
        dataset_name, 
        transform, 
    ...
    def parse_row(self, json_line):
        ...
        image_inial = self.load_image_safely(data_item, 'img_path')
