...
if __name__ == "__main__":
    ...
    output_dir_refine = args.output_dir+"_refine"
    os.makedirs(output_dir_refine, exist_ok=True)
    if rank == 0:
        print(f"Output images are saved in {output_dir_refine}")
    ...
    for idx in range(start, end):
        ...
        for sample in image_list:
            ...
            refine_image = refine_rusult.crop(refine_rusult.getbbox())
            sample_path_refine = f"{output_dir_refine}/{str(int(metadata['index']))}_{sample_count_refine}.png"
            refine_image.save(sample_path_refine)
