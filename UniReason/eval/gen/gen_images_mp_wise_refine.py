...
def refine_image_with_cot(
    ...
    cfg_img_newlens = [0]
    cfg_img_new_rope = [0]
    enhance_prompt = f"Strictly apply all thinking_text: {think_text} to refine and correct the input image, and ensure the final edited image is a perfect, faithful, and unambiguous realization of the caption: {prompt} better than the input image."
    # prepare text list
...
if __name__ == "__main__":
    ...
    for idx in range(start, end):
        ...
        outpath_refine = os.path.join(output_dir+"_refine", f"{prompt_id}.png")
